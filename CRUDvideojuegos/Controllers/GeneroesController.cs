    ...
    public class GeneroesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Generos != null ? 
                          ...
                          Problem("Entity set 'VideojuegosContext.Generos'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("IdGenero,NombreGenero,FechaRegistro")] Genero genero)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdGenero,NombreGenero,FechaRegistro")] Genero genero)
        {
