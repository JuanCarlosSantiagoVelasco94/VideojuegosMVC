...
namespace CRUDvideojuegos.Controllers
{
    public class VideojuegoesController : Controller
    {
        ...
        {
              return _context.Videojuegos != null ? 
                          View(await _context.Videojuegos.ToListAsync()) :
                          Problem("Entity set 'VideojuegosContext.Videojuegos'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("IdVideojuego,Nombre,Descripcion,FechaLanzamiento,Calificacion,GeneroId,ConsolaId")] Videojuego videojuego)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdVideojuego,Nombre,Descripcion,FechaLanzamiento,Calificacion,GeneroId,ConsolaId")] Videojuego videojuego)
        {
